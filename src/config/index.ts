...
const serverConfig: ServerConfig = {
	...
	BULLMQ_ROOM_GENERATION_ADD_PAYLOAD_ATTEMPTS: Number(process.env.BULLMQ_ROOM_GENERATION_ADD_PAYLOAD_ATTEMPTS) || 3,
	BULLMQ_ROOM_GENERATION_ADD_PAYLOAD_DELAY: Number(process.env.BULLMQ_ROOM_GENERATION_ADD_PAYLOAD_DELAY) || 1000,
};
