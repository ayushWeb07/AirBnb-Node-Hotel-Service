...
router.delete("/:id", validateRequestUrlParams(hotelValidator.removeSchema), hotelsController.remove);
router.patch("/:id", validateRequestUrlParams(hotelValidator.updateUrlParamsSchema), validateRequestBody(hotelValidator.updateBodySchema), hotelsController.update);
