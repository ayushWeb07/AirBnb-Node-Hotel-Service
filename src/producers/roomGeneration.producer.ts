...
const addJobToRoomGenerationQueue = async (payload: createRoomGenerationJob) => {
    try {
        await roomGenerationQueue.add(serverConfig.BULLMQ_ROOM_GENERATION_PAYLOAD_NAME, payload, {
